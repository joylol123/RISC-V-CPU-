...
// ============ Ctrl signal ============== //
    ...
    .MEM_DMread_sel(EXE_MEM_DM_read), // before EXE_MEM_DM_read_sel
...
comparator comparator_inst(
    .instr_com(IF_ID_instr),.B_branch_flag(com_Dy_B_branch_flag),
...
always_ff @(posedge clk) begin
    ...
    // ======== CONTROL ====== //
        ...
        ID_EXE_rs1          <=  (wire_ctrl_sig_flush) ? 0 : wire_ID_EXE_rs1;
        ID_EXE_rs2          <=  (wire_ctrl_sig_flush) ? 0 : wire_ID_EXE_rs2;
